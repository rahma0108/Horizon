...
<body>
                ...
                <div class="reservation-form">
                    <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="date_reservation_container"></div>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="nombre_personnes_container"></div>
                            <div class="invalid-feedback">
    ...
    <script>
        ...
        dateInput.id = 'date_reservation';
        dateInput.name = 'date_reservation';
        dateInput.required = true;
        dateInput.min = new Date().toISOString().split('T')[0];
        document.getElementById('date_reservation_container').appendChild(dateInput);

        // Create number of people input
        const peopleInput = document.createElement('input');
        peopleInput.type = 'number';
        peopleInput.className = 'form-control';
        peopleInput.id = 'nombre_personnes';
        peopleInput.name = 'nombre_personnes';
        peopleInput.min = '1';
        peopleInput.required = true;
        document.getElementById('nombre_personnes_container').appendChild(peopleInput);
