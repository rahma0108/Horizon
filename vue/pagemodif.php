...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $pc=new eventsC();
    $p=new event($_POST['title'],$_POST['description'],$_POST['sport_type'],$_POST['location'],$_POST['event_date'],$_POST['max_participants'],$_POST['created_by'],$_POST['image']);
    $pc->updateEvent($p,$id);
        ...
        <div class="card">
            ...
            <form action="pagemodif.php?id=<?= $p['id'] ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="event_date" id="event_date" required value="<?= date('Y-m-d\TH:i', strtotime($p['event_date'])) ?>">
                </div>
                <div class="form-group">
